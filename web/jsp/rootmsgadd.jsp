                ...
                <div class="span12">
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            ...
                            <form action="/root/addmsgtchange" method="post">

                                <div class="form-group">
                                    <label for="nfloor">内容： </label>
                                    <textarea type="text" name="messagetext" class="form-control"  style="width: 60%;height: 10%" id="nfloor"  required></textarea>
                                </div>  <br/>
                                <div class="form-group">
                                    <label for="weizhi">时间：</label>
                                    <input type="text" name="messagetome" class="form-control"  id="weizhi" required>
                                </div><br/>
